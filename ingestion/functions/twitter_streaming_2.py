...
def topics_config(topics: list[str], servers: str=servers) -> None:
...
def check_rules(bearer_token: str, rules: list[str], tags: list) -> None:
  """Check if rules already attached. Will delete old rules if has. Will add new 
     rules in either case."""
  def add_rules(client: tweepy.StreamingClient, rules: list[str], tags: list) -> None:
